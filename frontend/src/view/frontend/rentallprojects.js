...
export default function RentAllprojects() {
    ...
    var LocationState, StateLocation, RoleData, Data;
                                ...
                                <div className="lefserch">
                                    ...
                                    <div className="by_popup_button">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalctsave"><i
                                            ...
                                            <span>save</span></a>
                                        <a className="share_soc" data-bs-toggle="dropdown"
                                            aria-expanded="false"><i className="fa fa-share-alt fa-lg"></i><span>Share</span></a>
                                ...
                                <div className="by_right_part">
                                    <div className="right_top_part">
                                        <ul>
                                            ...
                                            <li><a href=""> Posted By Agents (20)</a></li>
                                        </ul>
                                    </div>
