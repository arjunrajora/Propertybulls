...
export default function PropertyFacingType() {
  const location = useLocation();
   const { lineData } = location.state;
   const { id } = location.state;
   console.log(lineData.description);
   var options = {
    headers: {
  ...
  const Edit = async (event) => {
    ...
    const apiUrl = config.API_URL + 'propertyTypes/'+id;
                      ...
                      >
                        <div className="form-body">
                          <h2 className="form-section">
                            <i className=""></i>EDIT PROPERTY TYPE
                          </h2>
