...
function ProjectAdd() {
  ...
  const handleValue1Change = (e) => {
    ...
    const regex = /^[0-9]{0,5}$/; // Regex to match only 6-digit numbers

    if (regex.test(input)) {
      setArea(input);
    } else {
      alert('Please Enter Only Numeric Characters with up to 6 digits!');
    }
  };
  ...
  const handleImageChange = (e) => {
    ...
    // const newImages = [...img, ...imagesArray];
  ...
  const AddProject = async (event) => {
    ...
    console.log(body, "fds");
    body.append('type', 1);
    body.append('cus_id', build_id);
    ...
    const url = config.API_URL + "project/projectadd"
                    ...
                    <div className="card-body">
                      ...
                      >
                        ...
                        <div className="form-body"  >
                          <h2 className="form-section"> ADD PROJECT</h2>
                          ...
                          <div className="form-group">
                            <div className="row">
                              ...
                              {(show === '321' || show === '320' || show === '322' || show === '357' || show === '356' || show === '342' || show === '325' || show === '327' || show === '326' || show == '0') &&
                                <div className="col-sm-6 col-md-4 col-5">
