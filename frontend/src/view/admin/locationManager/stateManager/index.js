...
const DeleteState = config.API_URL + "state/"
const Statusapi = config.API_URL + "state/status/"
                    ...
                    <div className="heading-elements">
                      <ul className="list-inline mb-0 d-flex align-items-center">
                        <li>
                          ...
                          >
                            <i className="la la-plus"></i> <span>ADD STATE</span>
                          </Link>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="table-responsive">
                      <table className="table table-bordered table-hover">
                        ...
                        {isLoading ? (
                          ...
                          <tbody>
                            {state.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((value, index) => {
                              return (
                                <tr key={value.id}>
                                  <td>{index + 1}</td>
                                  <td>{value.name}</td>
                                    ...
                                    <div className="d-flex align-items-center">
                                      <Switch
                                        ...
                                        onChange={async (e) => {
                                          ...
                                          var res = await axios.put(Statusapi + value.id, body, options);
                                          const msg = res.data.message;
                                          localStorage.setItem(
                                            "staticAdded",
                                            msg
