...
const URL = config.API_URL + "clint/property/ResidentialPlot";
...
export default function Residentialplot() {
  ...
  useEffect(() => {
    ...
    fetch(URL)
      ...
      .then((value) => {
        setProperty(value.data.residentialPlot);
                            ...
                            <div className="col-lg-8">
                              <div className="by_right_main">
                                <div className="abc_appartment">
                                  ...
                                  <Link to={`/propertytshow/${value.url}`} className="abc_click">
                                    {value.name}
                                  </Link>
                                  <p>
