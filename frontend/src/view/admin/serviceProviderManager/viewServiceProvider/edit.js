...
export default function ServiceProviderEdit() {
  ...
  const [category, setCategory] = useState(lineData.category);
  const [email, setEmail] = useState(lineData.email);
  const [company_name, setCompany_name] = useState(lineData.company_name);
  const [company_url, setCompany_url] = useState(lineData.company_url);
  const [company_logo, setCompany_logo] = useState("");
  const [start, setStart] = useState(lineData.start);
  const [per_name, setPer_name] = useState(lineData.per_name);
  const [landline, setLandline] = useState(lineData.landline);
  ...
  const [location_id, setLocation_id] = useState(lineData.location_id);
  ...
  const EditViewServiceProvider = async (event) => {
    ...
    console.log(body);
    const url = config.API_URL + "serviceProvider/service/" + id;
    await axios
                        ...
                        <div className="form-body">
                          ...
                          <div className="form-group">
                            <div className="row">
                              ...
                              <div className="col-sm-6 col-md-4 col-5">
                                ...
                                <div> <img alt="Image" src={config.Image_URL + lineData.company_logo} height="100px" width="100px" /></div>
                          ...
                          <div className="form-actions">
                            <button
                              type="submit"
                              // onClick={"spinner()"}
                              onClick={EditViewServiceProvider}
